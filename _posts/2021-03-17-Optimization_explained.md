...
![https://s3-us-west-2.amazonaws.com/secure.notion-static.com/a77c84f8-2598-4711-98b4-6b461cf641be/Untitled.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/a77c84f8-2598-4711-98b4-6b461cf641be/Untitled.png)
...
<img src = '{{site.url}}/assets/img/optimization_fat.png' align = 'center'>
...
<img src = '{{site.url}}/assets/img/optimization_hap.png' align = 'center'>
...
- 선형 모델을 학습한다는 것은 이 무한한 공간에서 주어진 데이터를 가장 잘 설명하는 **최적의** `모델 파라미터`를 찾는 과정을 학습이라고 한다. 이 과정에서 최적화가 필요하다. 회귀 모델에서 데이터를 잘 설명한다는 것은 **x가 주어졌을 때 y값을 잘 예측**하는 것이다.
...
#선형 회귀 모델 시각화
y_pred = reg.coef_ * x + reg.intercept_  #(coef_, intercept_) = w_1, w_2

plt.figure(figsize = (8,5))
sns.scatterplot(x,y)
sns.lineplot(x,y_pred,color = 'r')
```
<img src = '{{site.url}}/assets/img/optimization_w_pred.png' align = 'center'>
...
# 마무리
- 학습시 loss function을 조작하는 이유와 효과를 이해할 수 있도록 머신러닝을 공부하며 자주 등장하는 `최적화`라는 개념을 설명했다.
